"""
Django settings for StellerProject project.
...
ROOT_URLCONF = 'StellerProject.urls'
...
# Where Django looks for static files before collecting
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'stellerapp/static'),
]

# Enable WhiteNoise's GZip
